...
La collecte s'est étendue sur 14 jours : une semaine avant le vote (5–11 octobre) et une semaine après (13–19 octobre). Les feedbacks ont été recueillis par les agents CEA dans 10 régions du Cameroun, via échanges directs, groupes communautaires et appels téléphoniques.

crc-feedback-electoral-2025/
├── README.md                          ← Ce fichier
├── data/
│   ├── crc_feedback_electoraux.xlsx   ← Matrice de données Excel
│   └── verbatim_des_codes.xlsx        ← Verbatims codifiés ATLAS.ti
├── analysis/
...
│       ├── chart1_categories.png
│       ├── chart2_sentiment.png
│       ├── chart3_odds_ratio.png
│       ├── chart4_temporal.png
│       ├── chart5_milieu_langue.png
│       ├── chart6_regions.png
│       └── chart7_connaissance_confiance.png
└── reports/
...
1. Campagne multilingue ciblée. Zones rurales Nord, Extrême-Nord, NOSO : développer des messages CRC en Fulfuldé et Pidgin. Le lien milieu rural = langue locale est le résultat statistiquement le plus fort de l'analyse (V=0,659).
...
ATLAS.ti	Codification qualitative des feedbacks	Version Web / Desktop
